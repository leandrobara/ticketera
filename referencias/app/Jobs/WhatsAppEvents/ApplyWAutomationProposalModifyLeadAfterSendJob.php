...
class ApplyWAutomationProposalModifyLeadAfterSendJob implements ShouldQueue
{
    ...
    {
        $lockKey = 'ApplyWAutomationProposalModifyLeadAfterSendJob:wapSendingMsgId:' . $this->wapSendingMsgId;
        ...
        $appliedWAutLog = resolve(WAutomationProposalModifyLeadAfterSendService::class)->apply($wapSendingMsg);
        if ($appliedWAutLog) {
