...
use App\Jobs\WhatsAppEvents\Traits\InjectWapSenderLog;
use App\Services\API\Dispatchers\WhatsAppEventsDispatcherService;
    

class SendWAPSenderMessageJob implements ShouldQueue
{

    use CustomDispatchable, InteractsWithQueue, Queueable, SerializesModels, InjectWapSenderLog;
    ...
    protected function requeueThisJob(
        ...
        resolve(WhatsAppEventsDispatcherService::class)->dispatchSendWAPSenderMessageJob($wapSendingMsg, $delaySecs);
    ...
    {
        // Por ahora no duplico este job, mantengo el de wapi
