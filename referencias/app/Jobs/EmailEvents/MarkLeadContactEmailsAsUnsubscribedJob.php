...
class MarkLeadContactEmailsAsUnsubscribedJob implements ShouldQueue
{
    ...
    {
        $lockKey = 'MarkLeadContactEmailsAsUnsubscribedJob:handle:' . implode(',', $this->leadContactEmailIds);
        ...
        $service->markAsUnsubscribed($leadContactEmails);
