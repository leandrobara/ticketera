...
class SaveWhatsAppSendingMessageScheduledTimelineEventJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        resolve(EventsLogService::class)->saveWhatsAppSendingMessageScheduledTimelineEvent(
