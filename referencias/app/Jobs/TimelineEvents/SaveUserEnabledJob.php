...
class SaveUserEnabledJob implements ShouldQueue
{
    ...
    public function __construct(
        ...
        private readonly int $enabledUserId,
    ...
    public function handle()
    {
        ...
        $enabledUser = User::findOrFail($this->enabledUserId);
        resolve(EventsLogService::class)->saveUserEnabled($loginUser, $enabledUser, $this->eventLogDate);
    }
