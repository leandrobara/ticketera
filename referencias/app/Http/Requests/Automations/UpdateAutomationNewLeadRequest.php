...
class UpdateAutomationNewLeadRequest extends APIBaseRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'triggering_landing_ids' => ['present', 'nullable', 'array'],
            ...
            'do_not_send_email' => ['required', 'boolean'],
            'send_grouped_email' => ['required', 'boolean'],
            'do_not_send_whatsapp_message' => ['required', 'boolean'],
            'send_grouped_whatsapp_message' => ['required', 'boolean'],
            ...
            'auto_reply_do_not_send_out_of_hour' => ['required', 'boolean'],
            'add_new_task' => ['required', 'boolean'],
            ...
            if (!$validator->failed()) {
                ...
                if ($this->assignUserIds) {
                    ...
                    if (count($this->assignUserIds) != $usersToAssign->count()) {
                        $validator->errors()->add('assign_user', 'assign_user_does_not_exist');
                        return false;
                    }
    ...
    public function validatedDTO(): AutomationNewLeadDTO
    {
        ...
        $val['assignUserIds'] = $this->assignUserIds;
