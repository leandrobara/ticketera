...
class WhatsAppMetaAPICancelSendingRequest extends APIBaseRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            if (!$validator->failed()) {
                ...
                if (!$whatsAppSending->isWhatsAppMetaAPIType()) {
                    $validator->errors()->add('whatsapp_sending', 'whatsapp_sending_is_not_whatsapp_meta_api_type');
                    return false;
                }
            }
        });
