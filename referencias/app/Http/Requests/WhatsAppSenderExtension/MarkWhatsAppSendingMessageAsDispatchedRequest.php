...
class MarkWhatsAppSendingMessageAsDispatchedRequest extends APIBaseRequest
{
        ...
        $validator->after(function ($validator) {
            if (!$validator->failed()) {
                ...
                if ($wapMsg->dispatched_date) {
                    $errorBag->add('whatsapp_sending_message', 'whatsapp_sending_message_was_already_dispatched');
                    return false;
                }
                if ($wapMsg->sent_date) {
