...
namespace App\Http\Requests\Views\ClientyConfigurations\CustomerTrackingJourney;

use App\Http\Requests\APIBaseRequest;


class ShowCustomerTrackingJourneyRequest extends APIBaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'filters.search' => ['required', 'string'],
        ];
    }
    ...
    public function getSearchTerm(): string
    {
        ...
        return (string) $val['filters']['search'];
    }
