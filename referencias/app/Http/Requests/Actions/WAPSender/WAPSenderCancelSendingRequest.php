...
class WAPSenderCancelSendingRequest extends APIBaseRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            if (!$validator->failed()) {
                ...
                if (!$whatsAppSending->isWapSenderJobType()) {
                    $validator->errors()->add('whatsapp_sending', 'whatsapp_sending_is_not_wap_sender_job_type');
                    return false;
                }
            }
        });
