...
class UpdateLeadCustomFieldRequest extends APIBaseRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            if (!$validator->failed()) {
                ...
                $leadCustomFieldId = request()->leadCustomField->id;
                ...
                if (request()->leadCustomField->client_id != $clientId) {
                ...
                $leadCustomFieldExists = LeadCustomField::where('client_id', $clientId)
                    ->where('name', $leadCustomFieldName)
                    ->where('id', '<>', $leadCustomFieldId)
                    ->count()
                ;
