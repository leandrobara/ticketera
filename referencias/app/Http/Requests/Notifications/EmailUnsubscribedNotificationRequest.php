...
class EmailUnsubscribedNotificationRequest extends APIBaseRequest
{
    ...
    public function getValidatedDTO(): UnsubscribedEmailNotificationDTO
    {
        $val = self::validated();
        $dto = UnsubscribedEmailNotificationDTO::buildFromMailerEmailData($val['email']);
        return $dto;
    }
    ...
    {
        $val = self::validated();
        return 'EmailUnsubscribedNotification.' . $val['email']['id'];
    }
