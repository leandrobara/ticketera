...
class CreateNewIntegrationMakeAppLeadDTO
{
    ...
    public static function buildFromRequestArray(array $data): CreateNewIntegrationMakeAppLeadDTO
    {
        $dto = new CreateNewIntegrationMakeAppLeadDTO();
        
        $dto->loadUtms($data);
        $dto->note = ($data['note'] ?? []) ? $data['note'] : [];
        $dto->acquisitionChannel = $data['acquisitionChannel'] ?? null;
        $dto->message = ($data['message'] ?? null) ? $data['message'] : null;
        $dto->company = ($data['company'] ?? null) ? $data['company'] : null;
        $dto->mainLeadContactName = ($data['name'] ?? null) ? $data['name'] : null;
        $dto->otherFields = ($data['otherFields'] ?? []) ? $data['otherFields'] : [];
        $dto->mainLeadContactEmail = ($data['email'] ?? null) ? $data['email'] : null;
        $dto->mainLeadContactPhone = ($data['phone'] ?? null) ? $data['phone'] : null;
        $dto->landingUrl = ($data['landingUrl'] ?? null) ? $data['landingUrl'] : null;
        $dto->customFields = ($data['customFields'] ?? []) ? $data['customFields'] : [];
        $dto->mainLeadContactLastName = ($data['lastName'] ?? null) ? $data['lastName'] : null;
    ...
    protected function loadUtms(array $data): CreateNewIntegrationMakeAppLeadDTO
    {
