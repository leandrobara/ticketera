...
class UpdateIntegrationZapierAppLeadDTO
{
    ...
    public static function buildFromRequestArray(array $reqArray): UpdateIntegrationZapierAppLeadDTO
    {
        $attrs = $reqArray['lead'];
        $dto = new UpdateIntegrationZapierAppLeadDTO();
    ...
    public function setLeadDataFromRequestArray(array $attrs): UpdateIntegrationZapierAppLeadDTO
    {
    ...
    public function setLeadContactDataFromRequestArray(array $attrs): UpdateIntegrationZapierAppLeadDTO
    {
    ...
    public function setLeadContactPhoneDataFromRequestArray(array $attrs): UpdateIntegrationZapierAppLeadDTO
    {
    ...
    public function setLeadContactEmailDataFromRequestArray(array $attrs): UpdateIntegrationZapierAppLeadDTO
    {
    ...
    public function setCustomFields(array $attrs): UpdateIntegrationZapierAppLeadDTO
    {
