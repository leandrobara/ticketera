...
class UpdateIntegrationMakeAppLeadDTO
{
    ...
    public static function buildFromRequestArray(array $attrs): UpdateIntegrationMakeAppLeadDTO
    {
        $dto = new UpdateIntegrationMakeAppLeadDTO();
    ...
    public function setLeadDataFromRequestArray(array $attrs): UpdateIntegrationMakeAppLeadDTO
    {
    ...
    public function setLeadContactDataFromRequestArray(array $attrs): UpdateIntegrationMakeAppLeadDTO
    {
    ...
    public function setLeadContactPhoneDataFromRequestArray(array $attrs): UpdateIntegrationMakeAppLeadDTO
    {
    ...
    public function setLeadContactEmailDataFromRequestArray(array $attrs): UpdateIntegrationMakeAppLeadDTO
    {
    ...
    public function setCustomFields(array $attrs): UpdateIntegrationMakeAppLeadDTO
    {
