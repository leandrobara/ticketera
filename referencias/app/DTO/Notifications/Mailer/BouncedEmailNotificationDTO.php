...
class BouncedEmailNotificationDTO
{
    ...
    public static function buildFromMailerEmailData(array $emailData): BouncedEmailNotificationDTO
    {
        $dto = new BouncedEmailNotificationDTO();
