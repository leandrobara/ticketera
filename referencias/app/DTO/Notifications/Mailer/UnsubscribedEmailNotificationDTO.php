...
class UnsubscribedEmailNotificationDTO
{
    ...
    public static function buildFromMailerEmailData(array $emailData): UnsubscribedEmailNotificationDTO
    {
        $dto = new UnsubscribedEmailNotificationDTO();
