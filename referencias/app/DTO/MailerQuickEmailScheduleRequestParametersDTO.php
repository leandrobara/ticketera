...
class MailerQuickEmailScheduleRequestParametersDTO implements MailerRequestDTO
{
    ...
    public static function buildFromArray(array $data): MailerQuickEmailScheduleRequestParametersDTO
    {
        self::validate($data);

        $dto = new MailerQuickEmailScheduleRequestParametersDTO();
        $dto->to = $data['to'];
        $dto->body = $data['body'];
        $dto->from = $data['from'];
        $dto->cc = $data['cc'] ?? null;
