...
class UpdatePromotionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'value' => [
                Rule::requiredIf(in_array($type, ['percent_discount', 'fixed_discount'], true)),
                'nullable',
                'numeric',
                'decimal:0,6',
                'gt:0',
                Rule::when($type === 'percent_discount', ['lte:100']),
            ],
            'bundle_quantity' => [
            ...
            'access_code' => [
                ...
                'max:80',
                'regex:/^[a-z0-9-]+$/',
                Rule::unique('promotions', 'access_code')->ignore($promotion),
            ],
